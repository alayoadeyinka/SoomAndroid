...
public class BookSpecialistFreeAppointment extends utility {
	 private String reportDirectory = "reports";
	    	    
	  @BeforeMethod
	    public void setUp1() throws IOException {
		  log.info("----------------------START TEST - Book SpecialistFreeAppointment-----------------------------");
...
//THIS TEST VALIDATES THAT THE SYMPTOMS QUESTIONS AND ANSWERS ARE CORRECT 
  public void testBookFreeSpecialistAppointments() throws InterruptedException , IOException{
...
Row apptreason = sheetss.getRow(2);
Cell cell4 = apptreason.getCell(1);
String Apptreason  = cell4.getStringCellValue();

Row apptsymp = sheetss.getRow(3);
Cell cell5 = apptsymp.getCell(1);
String Apptsymp  = cell5.getStringCellValue();

Row specialty = sheetss.getRow(4);
Cell cell6 = specialty.getCell(1);
String Specialty  = cell6.getStringCellValue();

Row subspecialty = sheetss.getRow(5);
Cell cell7 = subspecialty.getCell(1);
String Subspecialty  = cell7.getStringCellValue();

Row doctorname = sheetss.getRow(6);
...
String Confirmspecialty= driver.findElement(By.xpath("//*[@resource-id='tsvb.sihaty.android:id/specialty']")).getText()  ;  
	 ...
	 //End
	      ...
	      driver.findElement(By.xpath("//*[@id='bookConsultation']"));
  ...
  // 	  driver.findElement(By.xpath("//*[text()[contains(.,'0.0)]]")).click();
   //	  log.info("Doctor Price is validated as Free"); 
	     ...
	     driver.findElement(By.xpath("//*[@text='Select date and time for consultation']"));
		     ...
		     driver.findElement(By.xpath("//*[@resource-id='tsvb.sihaty.android:id/icon']")).click();
		     ...
		     String consultfor= driver.findElement(By.xpath("//*[@id='consultationValue']")).getText()  ;   
			    ...
			    driver.findElement(By.xpath("//*[@text='Free']")).getText()  ; 
			    String text=driver.findElement(By.xpath("//*[@text='Free']")).getText() ;
			    
			    {    
			    {
			    	   if (text.equals("Free")) {
						  log.info("Consultation Confirmed as Free ");
			    	   ...
			    	   else
					      {
							  ...
							  TakesScreenshot screenshot=(TakesScreenshot)driver;
					      	  ...
					      	  // result.getName() will return name of test case so that screenshot name will be same as test case name
					      	   FileUtils.copyFile(src, new File(System.getProperty("user.dir")+"\\screenshots\\"+new SimpleDateFormat("yyyyMMddhhmm").format(new Date())+".jpg"));
					      	Assert.fail("Consultation is not  Confirmed as Free");	
					      } 
 ...
 driver.getPageSource().contains(SpecialistDrSpecialty);
 driver.getPageSource().contains(provider);
 log.info("----------------------END TEST - Book SpecialistFreeAppointment-----------------------------");
