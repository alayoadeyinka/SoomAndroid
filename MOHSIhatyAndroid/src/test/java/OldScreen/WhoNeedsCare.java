 ...
 String ConsultButton= driver.findElement(By.xpath(objectrepo.getProperty("BookConsultationButton"))).getText()  ;        
  ...
  String ConsultButton= driver.findElement(By.xpath(objectrepo.getProperty("BookConsultationButton"))).getText()  ;        
	      ...
	      try {
 	      ...
 	      driver.findElement(By.xpath(objectrepo.getProperty("CALL112")));

	      log.info("My Children, Add Child, Call 112 Text Confirmed  ");
 	      String emergency= driver.findElement(By.xpath(objectrepo.getProperty("EMERGENCYTITLE"))).getText()  ;        

	      Thread.sleep(1000); 
	      try {
	    	  if (CONFIG.getProperty("EmergencyText").equals(emergency)) {
	    		  log.info("Emergency Text Confirmed Okay ");
	    		 
	    	  }
	        } catch (NoSuchElementException e) {
	        	  log.info("Emergency Text is Not accurate  ");
	        }	      	      
	      
 	      driver.findElement(By.xpath(objectrepo.getProperty("EMERGENCYGUIDELINES"))).click();
  Thread.sleep(2000);
	      driver.findElement(By.xpath("//*[@text='Emergency Guidelines']")); 
	      ...
	      if (Platform.equals("SIHATY")){
	          ...
	          boolean emergencyText1 = driver.getPageSource().contains(CONFIG.getProperty("SihatyEmergencyGuidelinesText"));
		      ...
		      else
		      {
		      	...
		      	Assert.fail("Emergency Text1 is not correct ");
	      ...
	      boolean emergencyText2 = driver.getPageSource().contains(CONFIG.getProperty("EmergencyGuidelinesText2"));
	      if (emergencyText2 == true)
	      {
	      	 log.info("Emergency Text2 Confirmed ");
	      }
	      else
	      {
	      	TakesScreenshot screenshot=(TakesScreenshot)driver;
	      	...
	      	Assert.fail("Emergency Text2 is not correct ");     
 	      ...
 	      driver.findElement(By.xpath(objectrepo.getProperty("CALL112")));
 	      driver.findElement(By.xpath(objectrepo.getProperty("CLOSEBUTTON"))).click();
  	      driver.findElement(By.xpath(objectrepo.getProperty("MYCHILDREN")));
	      log.info("Emergency Guidelines Page Closed ");
