...
public class BookSpecialistAppointment extends utility {
	 private String reportDirectory = "reports";
	    	    
	  @BeforeMethod
	    public void setUp1() throws IOException {
		  log.info("----------------------START TEST - Book   SpecialistAppointments-----------------------------");
...
//THIS TEST VALIDATES THAT THE SYMPTOMS QUESTIONS AND ANSWERS ARE CORRECT 
  public void testBookSpecialistAppointments() throws InterruptedException , IOException{
