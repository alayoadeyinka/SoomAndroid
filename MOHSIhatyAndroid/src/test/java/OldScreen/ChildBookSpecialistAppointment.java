...
public class ChildBookSpecialistAppointment extends utility {
	 private String reportDirectory = "reports";
	    	    
	  @BeforeMethod
	    public void setUp1() throws IOException {
		  log.info("----------------------START TEST - Book  Child SpecialistAppointments-----------------------------");
...
//THIS TEST VALIDATES THAT THE SYMPTOMS QUESTIONS AND ANSWERS ARE CORRECT 
  public void testChildBookSpecialistAppointments() throws InterruptedException , IOException{
...
if (Platform.equals("SIHATY")){
	    	...
	    	String ConsultButton= driver.findElement(By.xpath("//*[@id='btn_book_consultation']")).getText()  ;        
	    			      ...
	    			      driver.findElement(By.xpath("//*[@id='tv_child_name']")).click();
	    			      Thread.sleep(2000);
	    			      log.info("Child Selected ");
...
String Confirmspecialty= driver.findElement(By.xpath("//*[@resource-id='tsvb.sihaty.android:id/specialty']")).getText()  ;  
 ...
 log.info("----------------------END TEST - Book Child  SpecialistAppointments-----------------------------");
	    			      ...
	    			      
	    				  {
	    				      ...
	    				      else
	    				      {
	    						  ...
	    						  log.info("----------------------END TEST - Book   SpecialistAppointments-----------------------------");
