...
public class ChildBookUrgentAppointments extends utility {
	 private String reportDirectory = "reports";
	    	    
	  @BeforeMethod
	    public void setUp1() throws IOException {
		  log.info("----------------------START TEST - Book Child Urgent Appointments -----------------------------");
...
//THIS TEST VALIDATES THAT THE SYMPTOMS QUESTIONS AND ANSWERS ARE CORRECT 
  public void testChildBookUrgentAppointment() throws InterruptedException , IOException{
   ...
   //   Thread.sleep(1000); 
      ...
      try {
	   ...
	   {	 
		  ...
		  log.info("----------------------END TEST - Book Child Urgent Appointments -----------------------------");
