...
XSSFSheet sheets = workbook.getSheet("Platform");
	   ...
	   String Platform  = cell11.getStringCellValue();
	    ...
	    if (Platform.equals("SIHATY")){
	    	  ...
	    	  driver.findElement(By.xpath(objectrepo.getProperty("BookUrgentAppointmentButtonImage"))); 	  
...
String UrgentConsultButton= driver.findElement(By.xpath(objectrepo.getProperty("UrgentAppointmentTitle"))).getText()  ;        
		      Thread.sleep(1000); 
		      try {
		    	  if (CONFIG.getProperty("UrgentButtonText").equals(UrgentConsultButton)) {
		    		  log.info("Urgent Consultation Button Confirmed Okay ");
		    	  }
		        } catch (NoSuchElementException e) {
		        	  log.info("Urgent Consultation Button is Not accurate  ");
		        }	     
		      
		      
			  String UrgentConsultSubButton=  driver.findElement(By.xpath(objectrepo.getProperty("UrgentAppointmentSubTitle"))).getText()  ;        
			  Thread.sleep(1000); 
		      try {
		    	  if (CONFIG.getProperty("UrgentButtonSubText").equals(UrgentConsultSubButton)) {
		    		  log.info("Urgent Consultation Sub Title Confirmed Okay ");
		    	  }
		        } catch (NoSuchElementException e) {
		        	  log.info("Urgent Consultation Sub Title is Not accurate  ");
		        }	    
	    			    	  
		      driver.findElement(By.xpath(objectrepo.getProperty("BookUrgentAppointmentButtonImage"))).click();
		      Thread.sleep(1000);	 
